...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.vel_x_angle_label = QtWidgets.QLabel(self.frame_4)
        self.vel_x_angle_label.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextSelectableByMouse)
        self.vel_x_angle_label.setObjectName("vel_x_angle_label")
        self.gridLayout_7.addWidget(self.vel_x_angle_label, 1, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.vel_z_angle_label, 4, 1, 1, 1)
        self.vel_y_angle_label = QtWidgets.QLabel(self.frame_4)
        self.vel_y_angle_label.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextSelectableByMouse)
        self.vel_y_angle_label.setObjectName("vel_y_angle_label")
        self.gridLayout_7.addWidget(self.vel_y_angle_label, 2, 1, 1, 1)
        ...
        self.acc_z_angle_label = QtWidgets.QLabel(self.frame_7)
        ...
        self.gridLayout_8.addWidget(self.acc_z_angle_label, 4, 1, 1, 1)
        ...
        self.acc_z_avg_angle_label = QtWidgets.QLabel(self.frame_7)
        self.acc_z_avg_angle_label.setObjectName("acc_z_avg_angle_label")
        self.gridLayout_8.addWidget(self.acc_z_avg_angle_label, 4, 3, 1, 1)
        self.acc_y_angle_label = QtWidgets.QLabel(self.frame_7)
        ...
        self.gridLayout_8.addWidget(self.acc_y_angle_label, 2, 1, 1, 3)
        self.label_30 = QtWidgets.QLabel(self.frame_7)
        self.label_30.setObjectName("label_30")
        self.gridLayout_8.addWidget(self.label_30, 0, 0, 1, 4)
        self.acc_x_angle_label = QtWidgets.QLabel(self.frame_7)
        ...
        self.gridLayout_8.addWidget(self.acc_x_angle_label, 1, 1, 1, 3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_15.setText(_translate("MainWindow", "Pozycja według żyroskopu"))
        self.label_22.setText(_translate("MainWindow", "Z:"))
        self.vel_x_angle_label.setText(_translate("MainWindow", "00"))
        self.vel_z_angle_label.setText(_translate("MainWindow", "00"))
        self.vel_y_angle_label.setText(_translate("MainWindow", "00"))
        ...
        self.label_36.setText(_translate("MainWindow", "Avg Z:"))
        self.acc_z_avg_angle_label.setText(_translate("MainWindow", "00"))
        self.acc_y_angle_label.setText(_translate("MainWindow", "00"))
        self.label_30.setText(_translate("MainWindow", "Pozycja według akcelerometru"))
